...
package com.danielzou.javacvsamples;
...
class FaceView extends View implements Camera.PreviewCallback {
    public static final String TAG = "FacePreview";
    ...
    public FaceView(FacePreview context) throws IOException {
        ...
        RetrieveClassifierTask retrieveClassifierTask = new RetrieveClassifierTask();
        retrieveClassifierTask.execute(new URL("https://raw.github.com/Itseez/opencv/2.4.0/data/haarcascades/haarcascade_frontalface_alt.xml"));
    }
    ...
    protected void processImage(byte[] data, int width, int height) {
        if (!classifier.isNull()) {
            ...
            // faces = cvHaarDetectObjects(grayImage, classifier, storage, 1.1, 3, CV_HAAR_FIND_BIGGEST_OBJECT | CV_HAAR_DO_ROUGH_SEARCH);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (faces != null) {
            ...
            s = "No faces detected.";
            canvas.drawText(s, (getWidth()-textWidth)/2, 50, paint);
        }
    }

    class RetrieveClassifierTask extends AsyncTask<URL, Void, File> {
        protected File doInBackground(URL... urls) {
            try {
                return Loader.extractResource(urls[0], null, "classifier", ".xml");
            } catch (IOException e) {
                e.printStackTrace();
            }
            return null;
        ...
        protected void onPostExecute(File classifierFile) {
            String classifierName = classifierFile.getAbsolutePath();
